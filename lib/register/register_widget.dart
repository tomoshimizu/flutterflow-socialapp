                ...
                children: [
                    ...
                    child: Autocomplete<String>(
                      ...
                      optionsViewBuilder: (context, onSelected, options) {
                        return AutocompleteOptionsList(
                          textFieldKey: _model.passwordTextFieldKey,
                          textController: _model.passwordTextFieldController!,
                      ...
                      onSelected: (String selection) {
                        setState(() =>
                            _model.passwordTextFieldSelectedOption = selection);
                        FocusScope.of(context).unfocus();
                      },
                      fieldViewBuilder: (
                        context,
                        ...
                        return TextFormField(
                          key: _model.passwordTextFieldKey,
                  ...
                  Padding(
                    ...
                    child: Autocomplete<String>(
                      ...
                      optionsViewBuilder: (context, onSelected, options) {
                        return AutocompleteOptionsList(
                          textFieldKey: _model.confirmPasswordTextFieldKey,
                          textController:
                      ...
                      onSelected: (String selection) {
                        setState(() =>
                            _model.confirmPasswordTextFieldSelectedOption =
                                selection);
                        FocusScope.of(context).unfocus();
                      },
                      fieldViewBuilder: (
                        ...
                        _model.confirmPasswordTextFieldController =
                            textEditingController;
                        return TextFormField(
                          key: _model.confirmPasswordTextFieldKey,
                          controller: textEditingController,
                          focusNode: focusNode,
                          onEditingComplete: onEditingComplete,
                          autofocus: true,

...
class _EditPostMessagePopupWidgetState
  ...
  void initState() {
    ...
    _model.updateTextFieldFocusNode ??= FocusNode();
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.updateTextFieldController ??=
                          TextEditingController(
                        text: containerUserPostsRecord.message,
                      ),
                      focusNode: _model.updateTextFieldFocusNode,
                      autofocus: true,
                      obscureText: false,
                      ...
                      validator: _model.updateTextFieldControllerValidator
                          .asValidator(context),
                    ),
                  ),
                  FFButtonWidget(
                    onPressed: () async {
                      await widget.userPostDocRef!
                        ...
                        message: _model.updateTextFieldController.text,
                      ));

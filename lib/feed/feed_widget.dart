...
class _FeedWidgetState extends State<FeedWidget> {
  ...
  void initState() {
    ...
    _model.messageTextFieldController ??= TextEditingController();
                        ...
                        Expanded(
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                8.0, 0.0, 8.0, 0.0),
                            child: TextFormField(
                              controller: _model.messageTextFieldController,
                              ...
                              validator: _model
                                  .messageTextFieldControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                          ...
                          onTap: () async {
                            await UserPostsRecord.collection.doc().set({
                              ...createUserPostsRecordData(
                                message: _model.messageTextFieldController.text,
                            ...
                            setState(() {
                              _model.messageTextFieldController?.clear();
                            });
                          },
                          child: Icon(
